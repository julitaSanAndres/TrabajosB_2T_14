...
public class MainActivity extends Activity implements SensorEventListener {
	...
	private TextView detectaProximidad;
	private TextView detectaVibracion;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		detectaProximidad = (TextView) findViewById(R.id.detecta);
		detectaVibracion = (TextView) findViewById(R.id.vibracion);
		...
		limpia.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				detectaProximidad.setText("");
				detectaProximidad.setBackgroundColor(Color.parseColor("#000000"));
				detectaVibracion.setText("");
				detectaVibracion.setBackgroundColor(Color.parseColor("#000000"));
		...
		synchronized (this) {
			...
			case Sensor.TYPE_ACCELEROMETER:
				...
				if ((event.values[0] > 15) || (event.values[1] > 15)
					...
					detectaVibracion.setBackgroundColor(Color.CYAN);
					detectaVibracion.setText("Vibracion Detectada");
			...
			case Sensor.TYPE_PROXIMITY:
				...
				if (event.values[0] == 0) {
					...
					detectaProximidad.setBackgroundColor(Color.RED);
					detectaProximidad.setText("Proximidad Detectada");
				}
